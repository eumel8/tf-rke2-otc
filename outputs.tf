...
output "rke2-nodes" {
  value = [opentelekomcloud_compute_instance_v2.rke2-server-1.access_ip_v4, opentelekomcloud_compute_instance_v2.rke2-server-2.access_ip_v4, opentelekomcloud_compute_instance_v2.rke2-server-3.access_ip_v4,]
}
